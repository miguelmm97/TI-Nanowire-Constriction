...
import numpy as np
from functions import spectrum, Ham_ThinFilm_Bi2Se3, xtranslation
...
kx = np.linspace(-4, 4, 300)          # kx in 1 / Å
ky = np.linspace(-4, 4, 300)          # ky in 1 / Å
...
# Lattice definition
L_z = 30                            # In units of a (average bond length)
...
for j in range(len(kx)):
    ...
    H = Ham_ThinFilm_Bi2Se3(L_z, z, kx[j], ky[j], A1, A2, B1, B2, C, D1, D2, M, a)
    E[:, j] = spectrum(H)[0]
