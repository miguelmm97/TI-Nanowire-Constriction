...
ax1_1.plot(np.repeat(-2 * Vstd_th_2d, 10), np.linspace(0, 10, 10), '--', color='#00B5A1', alpha=0.5)
ax1_1.text(2 * Vstd_th_2d - 10, 3, '$2\sigma$', fontsize=20, rotation='vertical', color='#00B5A1', alpha=0.5)
ax1_1.text(- 2 * Vstd_th_2d + 3, 3, '$2\sigma$', fontsize=20, rotation='vertical', color='#00B5A1', alpha=0.5)
...
ax2_1.text(fermi_zoom[index1], G_zoom[index1] + 1, '$a)$', fontsize=20)
ax2_1.plot(fermi_zoom[index2], G_zoom[index2], '.', markersize=10, alpha=0.9, color='#00B5A1')
ax2_1.text(fermi_zoom[index2], G_zoom[index2] + 0.8, '$b)$', fontsize=20)
ax2_1.plot(fermi_zoom[index3], G_zoom[index3], '.', markersize=10, alpha=0.9, color='#00B5A1')
ax2_1.text(fermi_zoom[index3], G_zoom[index3] + 0.1, '$c)$', fontsize=20)
ax2_1.plot(fermi_zoom[index4], G_zoom[index4], '.', markersize=10, alpha=0.9, color='#00B5A1')
ax2_1.text(fermi_zoom[index4], G_zoom[index4] + 0.1, '$d)$', fontsize=20)
